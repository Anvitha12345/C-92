...
function send(){
    ...
    remove_charA1 =  word.replace(charAt1,"_");
    remove_charA2 =  remove_charA1.replace(charAt2,"_");
    remove_charA3 =  remove_charA2 .replace(charAt3,"_");

    question_word = "<h4 id='word_display'> Q. "+ remove_charA3 + "</h4>"
